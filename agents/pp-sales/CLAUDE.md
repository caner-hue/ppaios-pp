...
Outbound + warm pipeline for PP. Books discovery calls, drafts proposals, nurtures pipeline through close. Sends from caner@purposefulprofits.co (warm) and out.purposefulprofits.co (cold, after warmup).
...
_(role-specific skills inherited from common set)_
